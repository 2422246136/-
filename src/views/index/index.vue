                    ...
                    <Submenu v-if="this.role.role==1" name="1">
                        ...
                        <MenuItem name="1-1" to="/index/homepage">
                           <i class="iconfont problemTracking-gongyingshangzhifu"></i>
                            ...
                            <MenuItem name="1-3" to="/index/supplierManagement">
                              <i class="iconfont problemTracking-wuliaoguanli-"></i>
                            查看课程
                            </MenuItem>
                            <MenuItem name="1-4" to="/index/customerManagement">
...
<!-- <i class="iconfont problemTstore.store.==1racking-gongyingshangzhifu"></i> -->
                        ...
                        <MenuItem name="2-1" to="/index/homepage">
                           <i class="iconfont problemTracking-gongyingshangzhifu"></i>
                                首页
                            </MenuItem>
                    <MenuItem name="2-2" to="/index/teacher">
                        <i class="iconfont problemTracking-gongyingshangguanli-"></i>
                        <span>个人信息</span>
                    </MenuItem>
                    <MenuItem name="2-3" to="/index/teacherCourse">
                            <i class="iconfont problemTracking-wuliaoguanli-"></i>
                            查看所属学生
                            </MenuItem>
                    <MenuItem name="2-4" to="/index/studentInformation">
                        <i class="iconfont problemTracking-yonghuguanli"></i>
                        <span>查看成绩</span>
                    </MenuItem>
                     </Submenu>
                                        <!-- 管理员模块 -->
                    <Submenu v-if="this.role.role==2" name="3">
                            <template slot="title">
                            <Icon type="ios-analytics" />
                             管理员管理
                        </template>
