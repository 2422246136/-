            ...
            <Row class="formGroup">
                <Col span="12">
                    ...
                    <Col span="19" class="itemForm">
                        <Input class="inputStyle" v-model="formItem.name" maxlength="10" disabled/>
                    </Col>
                </Col>
                <Col span="12">
                    <Col span="5" class="itemName">
...
<script>
import {Modal,Button,Input,Message,DatePicker,DropdownItem} from 'view-design'
export default {
    name:'student',
    components:{Modal,Button,Input,Message,DatePicker,DropdownItem},
